...
In this topology, we are using Loopback0 for underlaying routing and Loopback 1 for EVPN routing. Therefore, we will specify Loopback 1 as source for NVE interface. This will make sure that Loopback1 will be used as next-hop for EVPN routes. 
